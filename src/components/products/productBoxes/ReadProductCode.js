        ...
        <Form gridGap="2rem" marginBottom="1rem">
          <Container padding="0rem">
            <Input
              ...
              onChange={(event) => { console.log('on change',event.target.value.length); if ( !isScanned && event.target.value.length === 16) { addCode(event.target.value, true); setProductBoxCode('') };}}
